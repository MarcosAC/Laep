        ...
        {            
            set
            {
                ...
                if (arrayDadosDimensiomanemto != null)
                {
                    ...
                    tipoCaixa = $"{arrayDadosDimensiomanemto[2]}, {arrayDadosDimensiomanemto[3]}, {arrayDadosDimensiomanemto[4]}";
